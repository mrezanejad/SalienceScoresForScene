...
% -------------------------------------------------------------------------
% compute binary image as a list of conours
function CC = compute_binaryImage_as_contoursList_original(binaryImageImage)
binaryImageImage =~bwmorph(binaryImageImage,'skel',Inf);
